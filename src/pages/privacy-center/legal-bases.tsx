import LegalBases from "@/components/Privacy/LegalBases";
...
const LegalBasesIndex = (props: Props) => {
...
LegalBasesIndex.getLayout = getLayout;
export default LegalBasesIndex;
