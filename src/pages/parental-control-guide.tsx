...
const ParentalControlGuide = () => {
  return (
    <div className="bg-white w-full max-w-6xl mx-auto py-20 px-4">
      <h1 className='my-8 text-center'>PopChat Parental Control Guide</h1>

      <div className="space-y-8">
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-2">1. Who can legally access the website?</h3>
          <ul className="list-disc pl-6">
            <li>It is strictly prohibited for individuals who are under 18 years old (or the age of majority defined by their jurisdiction, if higher) to access content on PopChat .</li>
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-2">2. How can a parent/legal guardian restrict access to PopChat ?</h3>
          <p>Use “SafeSearch’’</p>
          <ul className="list-disc pl-6">
