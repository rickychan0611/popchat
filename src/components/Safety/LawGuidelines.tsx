    ...
    <div className="pt-[290px] bg-white min-h-screen font-[poppins]">
      <div className="w-screen min-w-[800px] max-w-[1000px] mx-auto relative overflow-auto">
        <div className="">
          ...
          <section className="mb-8">
            <h3>2. RFI Request Requirements</h3>
            <p className="mb-4">
            ...
            <h3>2.1 Law Enforcement or Regulatory Agency Information</h3>
            ...
            <br/>
            <p>(Note: Each RFI will be handled on a case by case basis and depending upon several factors the time needed to complete the request may vary greatly)</p>
            <h3>2.2 Supporting Documents</h3>
            ...
            <p className="mt-4"><strong>Note:</strong> PopChat recognizes other forms of legal documents that may be unique and ascribed to by jurisdictions. PopChat will internally review and verify each request and work closely with each LE/RE to facilitate lawful requests timely.</p>
          </section>

          <section className="mb-8">
            <h3>2.3 LE Request/Investigative Details</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h3>2.4 Types of Records and/or Information Requested</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h3>3. Emergency Requests for Information (ERFI) Requirements</h3>
            <p className="mb-4">
              Law Enforcement Information The following officer/agent information is <b>required</b> for each RFI:
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>Requesting Agency Name</li>
              <li>Requesting Agency Address</li>
